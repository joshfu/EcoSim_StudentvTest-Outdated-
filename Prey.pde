public class Prey extends Animal{
  public Prey(float x, float y, float entityWidth, float entityHeight, color entityColor, float opacity, String name, String type, float weight, float health, String gender, boolean hasTarget, int preferredType){
